...
C_DEFAULT_LOWER_RATE_LIMIT                 =       50
C_DEFAULT_UPPER_RATE_LIMIT                 =       150 
C_DEFAULT_ATRIAL_AMPLITUDE                 =       1
C_DEFAULT_ATRIAL_PULSE_WIDTH               =       1
C_DEFAULT_ATRIAL_SENSING_THRESHOLD         =       2
C_DEFAULT_ATRIAL_REFACTORY_PERIOD          =       300
C_DEFAULT_VENTRICULAR_AMPLITUDE            =       1
C_DEFAULT_VENTRICULAR_PULSE_WIDTH          =       1
C_DEFAULT_VENTRICULAR_SENSING_THRESHOLD    =       2
C_DEFAULT_VENTRICULAR_REFACTORY_PERIOD     =       300
